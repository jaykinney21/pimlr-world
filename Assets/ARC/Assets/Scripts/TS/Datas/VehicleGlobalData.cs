...
namespace TS.Generics
{
    ...
    public class VehicleGlobalData : ScriptableObject
    {
        ...
        public class CarParameters
        {
            ...
            public PlayerSpaceshipInformation currentPlayerSpaceshipInformation;
        ...
        /// Custom Codoe
        /// </summary>
        public List<APIGetData> CharacterList = new List<APIGetData>();
        public List<APIGetData> FlameList = new List<APIGetData>();
        ...
        public class Texts
        {
            ...
            public Texts(string v0, int v1, int v2, PlayerSpaceshipInformation v3)
            {
                paramName = v0;
                listID = v1;
                EntryID = v2;
