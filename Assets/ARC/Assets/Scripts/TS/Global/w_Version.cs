   ...
   void Version()
    {
        ...
        EditorGUILayout.LabelField("Version 1.0.4 for Unity 2022.3.4 LTS");
        EditorGUILayout.LabelField("Update for Unity 2022.3.4 LTS");

        EditorGUILayout.LabelField("");
        EditorGUILayout.LabelField("Old",EditorStyles.boldLabel);

        EditorGUILayout.LabelField("Version 1.0.3 for Unity 2022.1.0.");
        EditorGUILayout.LabelField("-[Correction] Championship result. Prevent the player to exit the championship without rewards.");
        EditorGUILayout.LabelField("-[Change] Vehicle velocity in some script (Unity 2022).");
        EditorGUILayout.LabelField("-[Change] Disable anti-aliasing on Renderer Texture (Vehicle Selection) (Unity 2022).");
        EditorGUILayout.LabelField("-[Correction] Medals available in Championship.");
        EditorGUILayout.LabelField("-[Correction] Championship Menu (LeftSpawn -1020).");
        EditorGUILayout.LabelField("-[Correction] Booster. Now it is not possible to use Booster during Loading.");
        EditorGUILayout.LabelField("-[Correction] Prevent bug when C is pressed during respawn.");
        EditorGUILayout.LabelField("    Assets/Scripts/TS/Camera/Cam_Follow.cs.");
        EditorGUILayout.LabelField("-[Optimisation] Remove Mask Map.");
