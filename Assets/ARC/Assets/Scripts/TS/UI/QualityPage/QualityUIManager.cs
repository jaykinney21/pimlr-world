...
namespace TS.Generics
{
    public class QualityUIManager : MonoBehaviour
    {
        ...
        private int                     currentResolution = 0;                          // PIMLR fix: restored (was commented out but used in #if UNITY_STANDALONE blocks -> CS0103 on Standalone target)
        public GameObject               objTxt_Resolution;                              // Use to display the actual resolution on screen
        private int                     LastHeightResolution = 0;                       // PIMLR fix: restored
        private int                     LastWidthResolution = 0;                        // PIMLR fix: restored
