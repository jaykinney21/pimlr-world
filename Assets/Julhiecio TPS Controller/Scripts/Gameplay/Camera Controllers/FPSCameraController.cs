    ...
    public class FPSCameraController : JUCameraController
    {
        ...
        void Update()
        {
            ...
            if (characterTarget != null)
            {
                ...
                //changes by game
                if (characterTarget.IsDriveByShooting && characterTarget.VehicleInShootingArea != null)
                {
                    UnityEngine.Debug.Log("IsDriveByShooting");
                    //xmouse = 0;
                    //ymouse = 0;
            ...
            {
                //UnityEngine.Debug.Log("characterTarget.IsDriving");
            ...
            ///changes by game
            else if (characterTarget.IsDriveByShooting)
            {
                SetCameraStateTransition(GetCurrentCameraState, Aiming ? AimModeCameraState : FPSCameraState);
                RotateCamera(xmouse, ymouse, upward: characterTarget == null ? TargetToFollow.up : characterTarget.transform.up);
            }
