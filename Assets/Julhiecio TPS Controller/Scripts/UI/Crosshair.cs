...
namespace JUTPS.UI
{
    ...
    public class Crosshair : MonoBehaviour
    {
        ...
        protected virtual void UpdateCrosshair()
        {
            ...
            {
                //Debug.Log("UpdateCrosshair::::"+ ( player.IsAiming ? true : player.FiringMode));
                SetActiveCrosshair(player.IsAiming ? true : player.FiringMode);
            }
            else
            {
        ...
        protected void HideCrosshairOnNoWeaponUsing()
        {
            ...
            Debug.Log("HideCrosshairOnNoWeaponUsing:::::" + ((player.HoldableItemInUseRightHand || player.HoldableItemInUseLeftHand) ? true : false));
        ...
        public void HideCrosshairOnAiming()
        {
            ...
            Debug.Log("HideCrosshairOnAiming::::" + !player.IsAiming);
