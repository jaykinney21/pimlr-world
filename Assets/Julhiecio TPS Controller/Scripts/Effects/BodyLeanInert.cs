...
namespace JUTPS.FX
{
    ...
    public class BodyLeanInert : JUTPSAction
    {
        ...
        void DoInert()
        {
            ...
            if (TPSCharacter.IsMeleeAttacking || TPSCharacter.IsRagdolled || TPSCharacter.IsAiming || TPSCharacter.FiringMode || TPSCharacter.IsDriving || TPSCharacter.IsDriveByShooting || TPSCharacter.IsDead || !TPSCharacter.IsGrounded)
            {
                Speed = 0;
                Lean = 0;
                return;
