...
namespace JUTPS.CrossPlataform
{
    ...
    public class MobileRig : MonoBehaviour
    {
        ...
        private void UpdateMobileScreen()
        {
            ...
            DrivingScreenPanel.SetActive(JUGameManager.InstancedPlayer.IsDriveByShooting);
        }
        ...
        private void UpdateMobileButtons()
        {
            ...
            if (JUGameManager.InstancedPlayer.IsDriving == false && JUGameManager.InstancedPlayer.IsDriveByShooting == false && EnterVehicleButton != null)
            {
