...
public class RCC_CarControllerV3 : RCC_Core {
    ...
    private float oldMaxEngineRPM = 0f;      
    
   // Old max RPM used for recreating the engine curve.
    #endregion
    ...
    [Range(.05f, 2f)] public float steeringSensitivityFactor = 1f;      // Steering sensitivity multiplier.
    ...
    public float NoSConsumption = 25f;
    public float NoSRegenerateTime = 10f;
